...
files = [
    r'C:\Users\Hanne\Documents\verkx\datafiles\20241004\decimated_20241004_1200.pkl',
    r'C:\Users\Hanne\Documents\verkx\datafiles\20241004\decimated_20241004_1205.pkl',
    r'C:\Users\Hanne\Documents\verkx\datafiles\20241004\decimated_20241004_1210.pkl',
]
...
# ═══════════════════════════════════════════════════════════════════════════════
# FIGURE 1 — The full space-time picture  
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# FIGURE 2 — Snapshot in space 
#           
# ═══════════════════════════════════════════════════════════════════════════════
t_idx = np.argmin(np.abs(tt - t_slice))
spatial_slice = data[t_idx, :]         
...
# ═══════════════════════════════════════════════════════════════════════════════
# FIGURE 4 — Three files side by side 
# ═══════════════════════════════════════════════════════════════════════════════
